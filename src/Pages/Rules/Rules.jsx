...
const Rules = () => {
  const rules = [
    ...
    "The initial price considered of the stock would be the closing price on the day before the submission day i.e., Wednesday the 19th January (tentatively)",
    ...
    <section className="rules" id="about">
      <div className="rules-heading">
        <div className="rules-heading__back">
          <button
            className="btn rules-heading__back__button"
            onClick={() => {
              navigate(-1);
            }}
          >
